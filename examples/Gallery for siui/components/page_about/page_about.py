...
class About(SiPage):
    def __init__(self, *args, **kwargs):
        ...
        self.version_picture.load("examples/Gallery for siui/img/logo_new.png")
        ...
        self.version_label.setText("PySide6-SiliconUI")
        ...
        with self.titled_widget_group as group:
            ...
            self.button_to_repo.clicked.connect(
                lambda: QDesktopServices.openUrl(QUrl("https://github.com/H1DDENADM1N/PySide6-SiliconUI"))
            )
        ...
        with self.titled_widget_group as group:
            ...
            self.option_card_copyright.setTitle("版权声明", "PySide6-SiliconUI 版权所有 © 2024 by H1DDENADM1N")
        ...
        with self.titled_widget_group as group:
            ...
            self.option_card_icon_pack.setTitle(
                "Fluent UI 图标库", "本项目内置了 Fluent UI 图标库，Microsoft 公司保有这些图标的版权"
            )
