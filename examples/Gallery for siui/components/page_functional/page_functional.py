...
class ExampleFunctional(SiPage):
    def __init__(self, *args, **kwargs):
        ...
        with self.titled_widgets_group as group:
            ...
            self.demo_displayer_1.loadInfo(
            ...
            self.demo_displayer_2.loadInfo(
            ...
            self.demo_displayer_3.loadInfo(
            ...
            self.demo_displayer_4.loadInfo(
            ...
            self.demo_displayer_5.loadInfo(
                "examples/Gallery for siui/img/pages/functional/music_covers/cover5.png",
                "Melting White",
                "塞壬唱片-MSR / Cubes Collective",
                "Melting White",
            )  # noqa: E501

            self.demo_displayer_6 = SiMusicDisplayer(self)
            self.demo_displayer_6.resize(512, 128)
            self.demo_displayer_6.loadInfo(
                "examples/Gallery for siui/img/pages/functional/music_covers/cover6.png", "Axolotl", "C418", "Axolotl"
            )  # noqa: E501
