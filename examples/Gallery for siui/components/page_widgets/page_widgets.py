...
from siui.components.slider_ import SiCoordinatePicker3D, SiSlider
...
class ExampleWidgets(SiPage):
    def __init__(self, *args, **kwargs):
        ...
        with self.titled_widgets_group as group:
            ...
            self.attachment_option_card.setTitle("测试选项卡", "点击按钮，播放显示或隐藏动画")
        ...
        with self.titled_widgets_group as group:
            ...
            self.refactor_progress_button.clicked.connect(
                lambda: self.refactor_progress_button.setProgress(random.random() * 1.3)
            )
            ...
            self.refactor_long_press_button.setToolTip(
                "Hold me to confirm.<br><strong>Your files will be lost forever!</strong>"
            )
            self.refactor_long_press_button.setSvgIcon(SiGlobal.siui.iconpack.get("ic_fluent_delete_filled"))
            self.refactor_long_press_button.longPressed.connect(
                lambda: self.refactor_long_press_button.setToolTip("Deleted!")
            )
        ...
        with self.titled_widgets_group as group:
            ...
            self.demo_named_line_edit_1.lineEdit().setText("PySide6-SiliconUI")
        ...
        with self.titled_widgets_group as group:
            ...
            self.progress_bar_linear.setSourceCodeURL(
                "https://github.com/H1DDENADM1N/PySide6-SiliconUI/blob/main/siui/components"
            ...
            self.ctrl_progress_bar_random_value.clicked.connect(
                lambda: self.demo_progress_bar.setValue(random.random())
            )  # noqa: E501
            ...
            self.ctrl_progress_bar_random_stepping.clicked.connect(
                lambda: self.demo_progress_bar.setValue(self.demo_progress_bar.value() + 0.1 * random.random())
            )  # noqa: E501
            ...
            self.progress_bar_circular.setSourceCodeURL(
                "https://github.com/H1DDENADM1N/PySide6-SiliconUI/blob/main/siui"
            ...
            self.ctrl_progress_bar_circular_random_value.clicked.connect(
                lambda: self.demo_progress_bar_circular.setValue(random.random())
            )  # noqa: E501
            ...
            self.ctrl_progress_bar_circular_random_stepping.clicked.connect(
                lambda: self.demo_progress_bar_circular.setValue(
                    self.demo_progress_bar_circular.value() + 0.1 * random.random()
                )
            )  # noqa: E501
            ...
            self.progress_bar_circular_indeterminate.setSourceCodeURL(
                "https://github.com/H1DDENADM1N/PySide6-SiliconUI"
        ...
        with self.titled_widgets_group as group:
            ...
            menu_test.addOption(
                "具有子目录的项",
                icon=SiGlobal.siui.iconpack.get("ic_fluent_add_circle_regular"),
                child_menu=menu_child_menu_test,
            )
            ...
            self.combobox.setSourceCodeURL(
                "https://github.com/H1DDENADM1N/PySide6-SiliconUI/blob/main/siui/components"
                "/widgets/progress_bar/progress_bar.py"
            )
        ...
        with self.titled_widgets_group as group:
            ...
            self.table_simple.setSourceCodeURL(
                "https://github.com/H1DDENADM1N/PySide6-SiliconUI/blob/main/siui/components"
                "/widgets/progress_bar/progress_bar.py"
            )
            ...
            self.table_managed.setSourceCodeURL(
                "https://github.com/H1DDENADM1N/PySide6-SiliconUI/blob/main/siui/components"
                "/widgets/progress_bar/progress_bar.py"
            )
        ...
        with self.titled_widgets_group as group:
            ...
            self.navigation_bar_h.setSourceCodeURL(
                "https://github.com/H1DDENADM1N/PySide6-SiliconUI/blob/main/siui/components"
                "/widgets/progress_bar/progress_bar.py"
            )
            ...
            self.navigation_bar_v.setSourceCodeURL(
                "https://github.com/H1DDENADM1N/PySide6-SiliconUI/blob/main/siui/components"
                "/widgets/progress_bar/progress_bar.py"
            )
        ...
        with self.titled_widgets_group as group:
            ...
            self.selection_bar_h.setSourceCodeURL(
                "https://github.com/H1DDENADM1N/PySide6-SiliconUI/blob/main/siui/components"
                "/widgets/progress_bar/progress_bar.py"
            )
            ...
            self.selection_bar_v.setSourceCodeURL(
                "https://github.com/H1DDENADM1N/PySide6-SiliconUI/blob/main/siui/components"
                "/widgets/progress_bar/progress_bar.py"
            )
        ...
        with self.titled_widgets_group as group:
            ...
            self.timeline.setSourceCodeURL(
                "https://github.com/H1DDENADM1N/PySide6-SiliconUI/blob/main/siui/components"
                "/widgets/progress_bar/progress_bar.py"
            )
            ...
            self.calender_view.setSourceCodeURL(
                "https://github.com/H1DDENADM1N/PySide6-SiliconUI/blob/main/siui/components"
                "/widgets/progress_bar/progress_bar.py"
            )
            ...
            self.time_picker.setSourceCodeURL(
                "https://github.com/H1DDENADM1N/PySide6-SiliconUI/blob/main/siui/components"
                "/widgets/progress_bar/progress_bar.py"
            )
            ...
            self.time_span_picker.setSourceCodeURL(
                "https://github.com/H1DDENADM1N/PySide6-SiliconUI/blob/main/siui/components"
                "/widgets/progress_bar/progress_bar.py"
            )
