...
class ExampleHomepage(SiPage):
    def __init__(self, *args, **kwargs):
        ...
        self.background_image.load("examples/Gallery for siui/img/homepage_background.png")
        ...
        self.background_fading_transition.setStyleSheet(
            ...
            """.format(SiGlobal.siui.colors["INTERFACE_BG_B"], SiColor.trans(SiGlobal.siui.colors["INTERFACE_BG_B"], 0))
        )
        ...
        self.option_card_project.setDescription(
            "check PySide6-SiliconUI Repository on GitHub to get the latest release, report errors, provide suggestions and more."
        )  # noqa: E501
        self.option_card_project.setURL("https://github.com/H1DDENADM1N/PySide6-SiliconUI")
        ...
        self.option_card_example.setDescription(
            "Check examples to understand how to use PySide6-SiliconUI to develop your first work."
        )  # noqa: E501
...
class OptionCardsExamplePanel(SiDenseVContainer):
    def __init__(self, *args, **kwargs):
        ...
        self.option_card_linear_attaching.setTitle(
            "Attach Widgets",
        ...
        body_label.setText(
            "SiOptionCardPlane provides three containers: header, body, and footer."
