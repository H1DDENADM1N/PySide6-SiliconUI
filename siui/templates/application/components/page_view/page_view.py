...
from siui.components.widgets import SiDenseHContainer, SiDenseVContainer, SiLabel, SiStackedContainer, SiToggleButton
...
class PageButton(SiToggleButton):
    ...
    def reloadStyleSheet(self):
        ...
        self.active_indicator.setStyleSheet(f"background-color: {self.getColor(SiColor.THEME)}")
...
class PageView(SiDenseHContainer):
    ...
    def addPage(self, page, icon, hint, side="top"):
        ...
        self.page_navigator.addPageButton(
            icon, hint, self._get_page_toggle_method(self.stacked_container.widgetsAmount() - 1), side
        )
