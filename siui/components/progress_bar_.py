...
class SiProgressBarRefactor(QProgressBar):
    ...
    class SiProgressBarRefactorProperty:
    ...
    def __init__(self, parent: T_WidgetParent = None) -> None:
        ...
        self.ani_prog_color = SiExpAnimationRefactor(self, self.SiProgressBarRefactorProperty.ProgressColor)
        self.ani_prog_color.init(1 / 4, 0.001, self._prog_color, self._prog_color)

        self.ani_prog_value = SiExpAnimationRefactor(self, self.SiProgressBarRefactorProperty.ProgressValue)
        self.ani_prog_value.init(1 / 4, 0.001, self._prog_value, self._prog_value)

        self.ani_flash_color = SiExpAnimationRefactor(self, self.SiProgressBarRefactorProperty.FlashColor)
